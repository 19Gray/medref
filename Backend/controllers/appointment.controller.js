    ...
    try {
      ...
      if (referral.patient && referral.patient.user && referral.patient.user.email) {
        ...
        const emailHtml = `
          ...
          0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
            <h2 style="color: #4a5568; text-align: center;">Appointment Confirmation</h2>
            <p>Dear ${patientName},</p>
            <p>We are pleased to inform you that your referral has been accepted
             by Dr. ${doctorName}, ${doctorSpecialization}.</p>
            ...
            <p>Please arrive 15 minutes before your scheduled appointment time.
             If you need to reschedule or cancel, please contact us at
             least 24 hours in advance.</p>
            <p>For any questions or concerns, please don't hesitate to
            contact us.</p>
            <p>Best regards,</p>
    ...
    if (appointment.patient && appointment.patient.user && appointment.patient.user.email) {
      ...
      const emailHtml = `
        ...
        auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          ...
          <p>If you have any questions about your diagnosis, treatment plan, or need to schedule a
          follow-up appointment, please don't hesitate to contact us.</p>
          <p>Best regards,</p>
